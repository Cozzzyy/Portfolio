...
export function AboutMe({ id }: AboutMeProps) {
    return (
        <motion.div
            ...
            initial="hidden"
            animate="show"
            className="flex flex-col items-center justify-center z-10 h-screen w-full md:w-2/3 lg:w-1/2 px-4 py-10"
        >
            <motion.h1
                variants={itemVariants}
                initial="hidden"
                animate="show"
                className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-white z-10 font-sans text-center"
            >
                Cosmin Nechita
            </motion.h1>
            <motion.h1
            ...
            >
                <img className="w-19 h-19" src="/java.png" alt="Java"/>
                <img className="w-14 h-14" src="/React.png" alt="React"/>
                <img className="w-14 h-14" src="/Spring.png" alt="Spring"/>
                <img className="w-14 h-14" src="/NET core.png" alt=".NET"/>
                <img className="w-14 h-14" src="/PostgresSQL.png" alt="DB"/>
            </motion.div>
            <ProjectsButton/>
        </motion.div>
    );
